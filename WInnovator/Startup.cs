...
namespace WInnovator
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider, IUserIdentityHelper userIdentityHelper)
        {
            ...
            CreateRoles(serviceProvider, userIdentityHelper).Wait();
            createUsersIfNonexisting(serviceProvider, userIdentityHelper).Wait();
            addRolesToDefaultUsers(serviceProvider, userIdentityHelper).Wait();
        }

        private async Task CreateRoles(IServiceProvider serviceProvider, IUserIdentityHelper userIdentityHelper)
        {
        ...
        private async Task createUsersIfNonexisting(IServiceProvider serviceProvider, IUserIdentityHelper userIdentityHelper)
        {
